      ...
      queue.textChannel
        .send({
          embeds: [
            new MessageEmbed()
              .setColor(ee.color)
              .setImage( `https://cdn.discordapp.com/attachments/1021653576981938229/1022925908983689319/static.jpg`
          )
      ...
      queue.textChannel.send({
        embeds: [
          new MessageEmbed()
            .setColor(ee.color)
            .setImage(
            `https://cdn.discordapp.com/attachments/1021653576981938229/1022925908983689319/static.jpg`
          )
            .setDescription(
